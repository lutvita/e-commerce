    ...
    <div class="row justify-content-center">
        <div class="col">
            ...
            <div class="row">
                <div class="col">
                    <h2>
                        <span class="badge badge-primary">Kode Post</span>
                    </h2>
                    <p>
                        {{ $order->zip_code }}
                    </p>
            ...
            <table id="cart" class="table table-hover table-condensed">
                ...
                <tbody>
                    ...
                    <tr>
                        <td data-th="Product">
                            <div class="row">
                                <div class="col-sm-3 hidden-xs"><img src="{{ route('products.image', ['imageName' => $orderItem->product->img_url]) }}" width="100" height="100" class="image-responsive" ></div>
                                <div class="col-sm-9">
